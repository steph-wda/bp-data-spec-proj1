...
############################# TO DO #####################################
    ...
    product_revenue ="""SELECT product_category, SUM(unit_price*quantity) as total_spent
                    FROM invoices
...
############## CREATING CSV FILES FROM OUTPUTS #########################
    ...
    with open('product_revenue.csv', 'w') as file:
        ...
        print("product_revenue.csv created successfully.")
